import { Code2, Brain, Cloud, Smartphone, Database, Shield } from 'lucide-react';
...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Intelligent systems that learn, adapt, and provide valuable insights for your business.',
    ...
    },
    {
      ...
      description: 'Scalable cloud infrastructure and seamless integration with leading cloud platforms.',
      features: ['AWS & Azure', 'Serverless Architecture', 'API Development', 'Microservices'],
    ...
    },
    {
      ...
      description: 'Robust data pipelines and analytics solutions to unlock the power of your data.',
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="text-center mt-16">
            <div className="bg-card rounded-2xl p-8 md:p-12 shadow-quantum fade-in-up" style={{ animationDelay: '1.2s' }}>
